...
func (m *defaultUserModel) FindOneByName(name string) (*User, error) {
	...
	var resp User
	err := m.QueryRowIndex(&resp, userNameKey, m.formatPrimary, func(conn sqlx.SqlConn, v interface{}) (interface{}, error) {
...
func (m *defaultUserModel) FindOneByNumber(number string) (*User, error) {
	...
	var resp User
	err := m.QueryRowIndex(&resp, userNumberKey, m.formatPrimary, func(conn sqlx.SqlConn, v interface{}) (interface{}, error) {
